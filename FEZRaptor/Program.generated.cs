...
namespace FEZRaptor {
    ...
    public partial class Program : Gadgeteer.Program {
        ...
        /// <summary>The RFID Reader module using socket 12 of the mainboard.</summary>
        private Gadgeteer.Modules.GHIElectronics.RFIDReader rfidReader;
        
        /// <summary>The Relay X1 module using socket 17 of the mainboard.</summary>
        private Gadgeteer.Modules.GHIElectronics.RelayX1 relayX1;
        
        /// <summary>The Button module using socket 16 of the mainboard.</summary>
        private Gadgeteer.Modules.GHIElectronics.Button button;
        
        /// <summary>The Character Display module using socket 15 of the mainboard.</summary>
        private Gadgeteer.Modules.GHIElectronics.CharacterDisplay characterDisplay;
        
        /// <summary>The LED 7C module using socket 14 of the mainboard.</summary>
        ...
        private void InitializeModules() {
            ...
            this.rfidReader = new GTM.GHIElectronics.RFIDReader(12);
            this.relayX1 = new GTM.GHIElectronics.RelayX1(17);
            this.button = new GTM.GHIElectronics.Button(16);
            this.characterDisplay = new GTM.GHIElectronics.CharacterDisplay(15);
            this.led7C = new GTM.GHIElectronics.LED7C(14);
        }
    }
}
